...
import com.mabeijianxi.smallvideorecord2.utils.SizeUtils;
...
public class RecordButtonView extends View {
    ...
    private void init() {
        ...
        currentStrokeWidth = SizeUtils.dp2px(10);
        paint.setStrokeWidth(currentStrokeWidth);//设置画笔粗细

        slideDis = SizeUtils.dp2px(10);
        radiusDis = SizeUtils.dp2px(3);
        strokeWidthDis = SizeUtils.dp2px(1) / 4;
